    ...
    <div className='container osp min-h-screen'>
      {
        ...
        <>
          ...
          <p className='osp-text'>Open source projects are a great way to learn and contribute to the community. Here are some beginner projects that you can contribute to.</p>
